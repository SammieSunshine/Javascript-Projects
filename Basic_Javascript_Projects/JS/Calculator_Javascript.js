...
function Input_Digit(digit) {
    ...
    //Display_Vaue to the key that was clicked.
...
//this section heandles decimal points
...
function Handle_Operator(Next_Operator) {
    ...
    // Calculator_First_Operand if it doesn't already exist
...
Update_Display();
//this section monitors button button clicks
const keys = document.querySelector('.calculator-keys');
keys.addEventListener('click', (event)=>{
    //the target variable is an object that represents the element
    //that was clicked
    const { target} = event;
    //if the elemtnt that was clicked on is not a button, exit the function
